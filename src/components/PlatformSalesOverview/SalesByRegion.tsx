...
const SalesByRegion: React.FC<Props> = ({ totalSoldByRegion, totalSold }) => {
  const graphData = [
    {
      y: totalSoldByRegion.eu,
      label: getLabel("EU", totalSoldByRegion.eu, totalSold),
    },
    {
      y: totalSoldByRegion.northAmerica,
      label: getLabel(
        "North America",
        totalSoldByRegion.northAmerica,
        totalSold
      ),
    },
    {
      y: totalSoldByRegion.japan,
      label: getLabel("Japan", totalSoldByRegion.japan, totalSold),
    },
    {
      y: totalSoldByRegion.others,
      label: getLabel("Others", totalSoldByRegion.others, totalSold),
    },
  ];
